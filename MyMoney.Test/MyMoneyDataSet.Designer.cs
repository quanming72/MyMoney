...
namespace MyMoney.Test {
    ...
    public partial class MyMoneyDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserRow AddUserRow(string User_Id, string User_Name, string Password, byte[] Avatar) {
            ...
            private void InitClass() {
                ...
                this.columnUser_Id.MaxLength = 38;
            ...
            public byte[] Avatar {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“User”中列“Avatar”的值为 DBNull。", e);
                    }
                }
                set {
...
namespace MyMoney.Test.MyMoneyDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([User_Id] = @Original_User_Id) AND ((@IsNull_Use" +
                "r_Name = 1 AND [User_Name] IS NULL) OR ([User_Name] = @Original_User_Name)) AND " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[User] ([User_Id], [User_Name], [Password], [Avatar]) VALUES (@" +
                "User_Id, @User_Name, @Password, @Avatar);\r\nSELECT User_Id, User_Name, Password, " +
                "Avatar FROM [User] WHERE (User_Id = @User_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [User_Id] = @User_Id, [User_Name] = @User_Name, [Password] = @Password, [Avatar] = @Avatar WHERE (([User_Id] = @Original_User_Id) AND ((@IsNull_User_Name = 1 AND [User_Name] IS NULL) OR ([User_Name] = @Original_User_Name)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT User_Id, User_Name, Password, Avatar FROM [User] WHERE (User_Id = @User_Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MyMoney.Test.Properties.Settings.Default.MyMoneyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT User_Id, User_Name, Password, Avatar FROM dbo.[User]";
        ...
        public virtual int Fill(MyMoneyDataSet.UserDataTable dataTable) {
        ...
        public virtual MyMoneyDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyMoneyDataSet.UserDataTable dataTable = new MyMoneyDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyMoneyDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(string Original_User_Id, string Original_User_Name, string Original_Password) {
        ...
        public virtual int Insert(string User_Id, string User_Name, string Password, byte[] Avatar) {
            if ((User_Id == null)) {
        ...
        public virtual int Update(string User_Id, string User_Name, string Password, byte[] Avatar, string Original_User_Id, string Original_User_Name, string Original_Password) {
            if ((User_Id == null)) {
                throw new global::System.ArgumentNullException("User_Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string User_Name, string Password, byte[] Avatar, string Original_User_Id, string Original_User_Name, string Original_Password) {
            return this.Update(Original_User_Id, User_Name, Password, Avatar, Original_User_Id, Original_User_Name, Original_Password);
        }
    }
